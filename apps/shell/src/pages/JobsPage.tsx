...
type JobStatus = "In Progress" | "Completed" | "Pending";
  ...
  const cfg =
    status === "Completed"
      ? {
          ...
          bd: "border-[rgba(34,197,94,0.25)]",
          tx: "text-[rgba(22,163,74,1)]",
          dot: "bg-[rgba(22,163,74,1)]",
          label: "Completed",
        }
      : status === "In Progress"
      ? {
          bg: "bg-[rgba(245,158,11,0.12)]",
          bd: "border-[rgba(245,158,11,0.25)]",
          tx: "text-[rgba(217,119,6,1)]",
          dot: "bg-[rgba(217,119,6,1)]",
          label: "In Progress",
        }
      : {
          bg: "bg-[rgba(148,163,184,0.16)]",
          bd: "border-[rgba(148,163,184,0.28)]",
          tx: "text-[rgba(71,85,105,1)]",
          dot: "bg-[rgba(71,85,105,1)]",
          label: "Pending",
        };
